    ...
    return (
        <div className="details">
            ...
            <DetailsData 
                ...
                text="Children with multiple disabilities have the right to learn and thrive, yet they are often invisible and excluded from school and community life. Some are isolated, never able to realise their full potential. Vocal Vibes works with schools to make sure every child is included."
                image1={img3}
                image2={img4}
            />
